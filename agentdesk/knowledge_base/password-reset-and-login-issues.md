...
**Summary:**
Step-by-step guidance for resetting your AgentDesk password, resolving common login failures, and recovering access to your workspace.
...
AgentDesk uses email-based authentication by default. If your workspace has SSO enabled, see the [SSO Setup and Troubleshooting](./sso-setup-and-troubleshooting.md) article instead.

---

## Resetting Your Password

1. Go to the AgentDesk login page at **app.agentdesk.io/login**.
2. Click **Forgot your password?** below the sign-in form.
3. Enter your registered email address and click **Send Reset Link**.
4. Check your inbox for an email from **noreply@agentdesk.io** — it may take up to 2 minutes to arrive.
...
> If you don't see the email, check your **Spam** or **Junk** folder. Ensure your email provider is not blocking messages from `agentdesk.io`.

---

## Password Requirements

AgentDesk enforces the following password policy:
...
- Double-check that you are using the correct email address associated with your AgentDesk account.
...
AgentDesk sessions expire after **7 days** of inactivity. Simply log in again to start a new session.
...
If you have used all backup codes and lost access to your authenticator, contact **support@agentdesk.io** with a government-issued ID and proof of account ownership.
...
3. AgentDesk will email a reset link directly to the user.
...
Check your spam folder first. If it's not there, ensure your email address is correctly registered. Contact support if the issue persists — your domain may be blocking emails from `agentdesk.io`.

**Q: Can I log in to multiple devices simultaneously?**
Yes. AgentDesk supports concurrent sessions across multiple devices. You can view and revoke active sessions at **Settings → Security → Active Sessions**.
